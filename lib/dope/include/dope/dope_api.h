/**
 * @file dope_api.h
 * @brief Public C-linkage API for the Digital Optical Performance Engine.
 *
 ...
 *
 * These values are IMU-hardware-specific and should be supplied by the application
